  ...
  <main class="pt-[4rem] h-screen overflow-auto text-center md:text-left bg-white text-dark-75 w-full">
    ...
    >
      <div class="container hidden xl:block">
        <div v-for="(item, index) in 100" :key="index" class="circle-container">
          <div class="circle" />
        </div>
      </div>
      <div>
        <p class="text-[48px] md:text-[64px] tracking-tighter pb-[2rem] md:pb-[4rem] xl:pb-[6rem] xl:pt-[2rem]">
          Hey, bienvenue.
        </p>
        ...
        <div class="space-y-[0.5rem] ml-1">
          ...
          <p class="font-bold text-secondary-dark">
            Actuellement disponible pour un poste en CDI ou des missions Freelance.
          </p>
